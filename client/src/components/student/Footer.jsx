...
const Footer = () => {
  return (
    ...
    <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
      Vero adipisci quam quas qui ducimus sint aperiam aliquid earum commodi vitae, 
      nobis, hic, quos ipsam fugiat quasi nihil repudiandae. Illum, facere! </p>
    </div>
    <div className='flex flex-col md:items-start items-centerc w-full'>
   ...
   <div>
    <input type="email" placeholder='Enter your email' className='border border-gray-500/30 bg-gray-800 text-gray-500 placeholder-gray-500 outline-none w-64 
