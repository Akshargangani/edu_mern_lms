  ...
  return (
    <div className='flex flex-col items-center justify-center w-full md:pt-36 pt-20
     px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
        ...
        relative font-bold text-gray-800 max-w-3xl mx-auto'>Empower your future with the course designed to <span className='text-blue-600'>fit 
          ...
          <p className='md:block hidden text-gray-500 max-w-2xl mx-auto'>we bring together world-class instructors,interactive content,and a supportive 
            community to help you achieve your person and professional goals.
          </p>
