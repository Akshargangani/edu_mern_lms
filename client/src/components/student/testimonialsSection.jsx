...
const testimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
        <h2 className='text-3xl font-medium text-gray-800'>testimonialsSection</h2>
        <p className='md:text-base text-gray-500 mt-3'>Hear from out learners as they share their journeys of transformation,
          success, and how our <br /> platform has made a difference in their lives.
        </p>
        <div className='grid grid-cols-4 ml-75 gap-8 mt-14'>
